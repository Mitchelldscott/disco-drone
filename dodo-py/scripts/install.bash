...
source ${PROJECT_ROOT}/dodo-py/scripts/install_buffpy.bash
...
source ${PROJECT_ROOT}/dodo-py/scripts/install_ros.bash
# fi
...
source ${PROJECT_ROOT}/dodo-py/scripts/install_tytools.bash
...
if [[ "${HOSTNAME}" == "edge"* ]]; then
	...
	$SUDO cp ${PROJECT_ROOT}/dodo-py/scripts/dodo.service /etc/systemd/system

else 

	if [[ "${DOCKER}" == "False" ]]; then
		source ${PROJECT_ROOT}/dodo-py/scripts/install_docker.bash
	fi
